...
export const UpdateLease = () => {
    ...
    const getTableLease = async() =>{
        try{
            const { data } = await axios.get(`http://localhost:3200/lease/getById/${id}`)
                                    ...
                                    <form action="#">
                                                ...
                                                <select  className="form-control" id="inputCellar" required>
                                                    {
                                                        cellars.map(({ _id, name }, i) => {
                                                            return (
                                                                <option defaultValue={tableLease.cellar} key={i} value={_id} >{name}</option>
                                                            )
                                                        })
                                                    }
                                                </select>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col form-group">
                                                ...
                                                <input defaultValue={tableLease.amount} type="number" className="form-control" id="inputAmount" name="amount" required />
                                            </div>
                                        </div>
                                        <br />
                                        <center>
